!function(a, b) {
    ...
    function p(a, b, c) {
        ...
        d.src = a,
        _ = d,
        ba ? aa.insertBefore(d, ba) : aa.appendChild(d),
        _ = null
    }
    function q(a, b, c) {
        function d(c) {
    ...
    function r() {
        if (_)
            return _;
        if (ca && "interactive" === ca.readyState)
            return ca;
    ...
    function s(a) {
        ...
        function h() {
            ...
            l += c.length - 2) : l += /^[\w$]+(?:\s*\.\s*[\w$]+)*/.exec(b)[0].length - 1
        }
        function i() {
        ...
        function j() {
            var b, c = a.slice(l - 1);
            b = "." == k ? /^\.\d+(?:E[+-]?\d*)?\s*/i.exec(c)[0] : /^0x[\da-f]*/i.test(c) ? /^0x[\da-f]*\s*/i.exec(c)[0] : /^\d+\.?\d*(?:E[+-]?\d*)?\s*/i.exec(c)[0],
            l += b.length - 1,
            n = 0
        }
        if (-1 == a.indexOf("require"))
            return [];
        for (var k, l = 0, m = a.length, n = 1, o = 0, p = 0, q = [], r = []; m > l; )
            b(),
            c() || (d() ? (e(),
            n = 1) : "/" == k ? (b(),
            "/" == k ? (l = a.indexOf("\n", l),
            -1 == l && (l = a.length)) : "*" == k ? (l = a.indexOf("*/", l),
            -1 == l ? l = m : l += 2) : n ? (f(),
            n = 0) : (l--,
            n = 1)) : g() ? h() : i() ? j() : "(" == k ? (q.push(p),
            n = 1) : ")" == k ? n = q.pop() : (n = "]" != k,
            o = 0));
        return r
    }
    ...
    if (!a.seajs) {
        ...
        var C = u.emit = function(a, b) {
          ...
          , K = /^.*?\/\/.*?\//;
        u.resolve = m;
        var L, M, N = "undefined" == typeof window && "undefined" != typeof importScripts && z(importScripts), O = /^(about|blob):/, P = !location.href || O.test(location.href) ? "" : e(location.href);
        if (N) {
            var Q;
            try {
                var R = Error();
        ...
        if (N)
            ...
            var _, Y = document, aa = Y.head || Y.getElementsByTagName("head")[0] || Y.documentElement, ba = aa.getElementsByTagName("base")[0];
            u.request = p
        }
        var ca, da, ea = u.cache = {}, fa = {}, ga = {}, ha = {}, ia = t.STATUS = {
            FETCHING: 1,
            SAVED: 2,
            LOADING: 3,
            LOADED: 4,
        ...
        t.prototype.pass = function() {
            for (var a = this, b = a.dependencies.length, c = 0; c < a._entry.length; c++) {
                for (var d = a._entry[c], e = 0, f = 0; b > f; f++) {
                    ...
                    g.status < ia.LOADED && !d.history.hasOwnProperty(g.uri) && (d.history[g.uri] = !0,
                    e++,
                    g._entry.push(d),
                    g.status === ia.LOADING && g.pass())
                }
                e > 0 && (d.remain += e - 1,
                a._entry.shift(),
                c--)
        ...
        t.prototype.load = function() {
            ...
            if (!(a.status >= ia.LOADING)) {
                ...
                for (d = 0; e > d; d++)
                    f = ea[c[d]],
                    f.status < ia.FETCHING ? f.fetch(g) : f.status === ia.SAVED && f.load();
                for (var h in g)
        ...
        t.prototype.exec = function() {
            function a(b) {
                ...
                if (d.status == ia.ERROR)
                    throw Error("module was broken: " + d.uri);
                return d.exec()
            }
            var c = this;
            if (c.status >= ia.EXECUTING)
                return c.exports;
            if (c.status = ia.EXECUTING,
        ...
        t.prototype.fetch = function(a) {
            ...
            function d(a) {
                ...
                da = null);
                var b, c = ha[h];
                for (delete ha[h]; b = c.shift(); )
                    a === !0 ? b.error() : b.load()
            }
            var e = this
              , f = e.uri;
            e.status = ia.FETCHING;
            var g = {
                uri: f
            };
            C("fetch", g);
            var h = g.requestUri || f;
            return !h || ga.hasOwnProperty(h) ? (e.load(),
            b) : fa.hasOwnProperty(h) ? (ha[h].push(e),
            b) : (fa[h] = !0,
            ha[h] = [e],
            C("request", g = {
                uri: f,
        ...
        t.define = function(a, c, d) {
            ...
            if (!N && !f.uri && Y.attachEvent && b !== r) {
                var g = r();
                g && (f.uri = g.src)
            }
            C("define", f),
            f.uri ? t.save(f.uri, f) : da = f
        }
        ,
        t.save = function(a, b) {
            var c = t.get(a);
            c.status < ia.SAVED && (c.id = b.id || a,
        ...
        u.require = function(a) {
            ...
            return b.status < ia.EXECUTING && (b.onload(),
            b.exec()),
            b.exports
        }
        ,
...
function(a) {
    ...
    function g(a, b, d, e) {
        ...
        (d.dataType=="jsonp"&&window.jpnb&&window.jpnb.call(f, a, g, b)),
...
function(a) {
    ...
    a(document).ready(function() {
        ...
        a(document).bind("MSGestureEnd", function(a) {
            ...
            b && (m.el.trigger("swipe"),
            m.el.trigger("swipe" + b))
        }).on("touchstart MSPointerDown pointerdown", function(b) {
            (!(r = g(b, "down")) || f(b)) && (q = r ? b : b.touches[0],
            b.touches && 1 === b.touches.length && m.x2 && (m.x2 = void 0,
            m.y2 = void 0),
            o = Date.now(),
            p = o - (m.last || o),
            m.el = a("tagName"in q.target ? q.target : q.target.parentNode),
            h && clearTimeout(h),
            m.x1 = q.pageX,
            m.y1 = q.pageY,
            p > 0 && 250 >= p && (m.isDoubleTap = !0),
            m.last = o,
            k = setTimeout(c, n),
            l && r && l.addPointer(b.pointerId))
        }).on("touchmove MSPointerMove pointermove", function(a) {
            (!(r = g(a, "move")) || f(a)) && (q = r ? a : a.touches[0],
            d(),
            m.x2 = q.pageX,
            m.y2 = q.pageY,
            s += Math.abs(m.x1 - m.x2),
            t += Math.abs(m.y1 - m.y2))
        }).on("touchend MSPointerUp pointerup", function(c) {
            (!(r = g(c, "up")) || f(c)) && (d(),
            m.x2 && Math.abs(m.x1 - m.x2) > 30 || m.y2 && Math.abs(m.y1 - m.y2) > 30 ? j = setTimeout(function() {
                m.el.trigger("swipe"),
                ...
                b.cancelTouch = e,
                m.el.trigger(b),
                m.isDoubleTap ? (m.el && m.el.trigger("doubleTap"),
...
function() {
    var a = function(a, b) {
        ...
        document.all ? d.onreadystatechange = function() {
            ("loaded" == d.readyState || "complete" == d.readyState) && e()
        }
        : d.onload = function() {
            e()
        }
